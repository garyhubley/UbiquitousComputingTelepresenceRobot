...
//-----------------------------------CSCI 6609---------------------------------------------
//------------------------------MoveForwardLittle.c------------------------------------------
//This program moves the NXT TeleP Bot forward only about six inches.
...
task main()
{
  ...
  //
  int nMoveSize     = 360;    // Four rotations
  int nSpeed        = 40;
  int nTurnRatio    = 100;  //C has same speed as A, but opposite direction
  int nCount;

  const TSynchedMotors kSyncType     = synchCA;
  ...
  {
    //
    // Move the motors forward four(04) revs of "A"
    //
